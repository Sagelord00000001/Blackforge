...
_NAME_NORMALIZERS: dict[EntityType, str] = {
    ...
    EntityType.EDGE_ENDPOINT: "slug",
    EntityType.ORIGIN_ENDPOINT: "slug",
    EntityType.ORIGIN_CANDIDATE: "slug",
    EntityType.PUBLIC_ADDRESS: "hostname-or-ip",
    EntityType.PRIVATE_ADDRESS: "hostname-or-ip",
    EntityType.INTERNAL_SERVICE: "hostname-or-ip",
    ...
    EntityType.CLOUD_PROVIDER: "slug",
    EntityType.CLOUD_ACCOUNT: "slug",
    EntityType.CLOUD_PROJECT: "slug",
    EntityType.CLOUD_REGION: "slug",
    EntityType.CLOUD_COMPUTE: "slug",
    EntityType.CLOUD_STORAGE: "slug",
    EntityType.CLOUD_DATABASE: "slug",
    EntityType.CLOUD_NETWORK: "slug",
    EntityType.CLOUD_CLUSTER: "slug",
    EntityType.CLOUD_CONTAINER: "slug",
    EntityType.CLOUD_SECRET: "slug",
